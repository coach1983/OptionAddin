	...
	(function () {
	    ...
	    function createTable() {
	        Excel.run(function (context) {
	            ...
	            OptionDataTable.getHeaderRowRange().values = [["Date", "Stock Price", "Strike Price", "Option Value"]];

	            OptionDataTable.rows.add(null /*add at the end*/, [["1/1/2017", "61", "65", "120"], ["1/1/2017", "61", "65", "120"], ["1/1/2017", "61", "65", "120"], ["1/1/2017", "61", "65", "120"], ["1/1/2017", "61", "65", "120"], ["1/1/2017", "61", "65", "120"]]);
	    ...
	    function BlackScholes(PutCallFlag, S, X, T, r, v) {
	        ...
	        if (PutCallFlag == "Call") return S * CND(d1) - X * Math.exp(-r * T) * CND(d2);else return X * Math.exp(-r * T) * CND(-d2) - S * CND(-d1);
	    }
	    ...
	    function CND(x) {
	        ...
	        if (x < 0.0) return 1 - CND(-x);else k = 1.0 / (1.0 + 0.2316419 * x);
